...
## Quarter sex-county Time series item count proportion plots
### nova by sex-county
nova_sex_county_quarter_count_prop_plot <- 
  ...
  df_max <- df_loyalty_analysis %>%
    ...
    mutate(total = n()) %>%
    ungroup() %>%
    group_by(across(c(quarter_date, county_name, total, gender, nova))) %>%
...
print(nova_sex_county_quarter_count_prop_plot)  


## Combined Quarter age-county time series plots 
### nova by Age-county item count
nova_sex_county_quarter_count_prop_plot_grid <- ggpubr::annotate_figure(
  ggpubr::ggarrange(plotlist = nova_sex_county_quarter_count_prop_plot,
                    ncol = NULL,
                    nrow = length(nova_sex_county_quarter_count_prop_plot),
                    labels = names(nova_sex_county_quarter_count_prop_plot),
...
nova_sex_county_quarter_count_prop_plot_grid


## Saving the Monthly sex-county grid plots
ggsave(plot=nova_sex_county_quarter_count_prop_plot_grid, height = 7, width = 12,
       filename = paste0("nova_sex_county_quarter_count_prop_plot",".png"),
